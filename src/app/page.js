...
function LandingPage() {
  ...
  return (
    ...
    <div id="cursor" className="hide1:hidden"></div>
      ...
      <div className="blob mt-9 md:mt-0 md:translate-y-1/4 lg:translate-y-1/4 lg:translate-x-1/2 hide1:w-[17rem] hide1:h-[17rem] md:w-[23rem] md:h-[23rem] lg:w-[25rem] lg:h-[25rem]">
      </div>

      <div className="intro hide1:mt-10 hide1:px-5 md:translate-y-1/4 lg:translate-y-1/4 hide1:text-center md:text-center lg:text-start lg:ml-4" style={teko.style}>
